...
**2026-09-26**
- Добавлена система анимации моделей состоящая из класса Animator и класса Bone.
- Добавлен hot reload файлов шейдеров.
- Добавлена сериализация\десериализация сцены в\из json.
- Добавлена возможность удаление объекта со сцены.

**2026-07-09**
- Изменение привязанной текстуры у примитивной модели

**2026-07-08**
- Пофиксен баг с залипшими клавишами управления в редакторе

**2026-07-03**
- Добавлен новое API для рендера.
- Добавлены новые RAII-сущности над Opengl типами

**2026-07-01**
- Logger. Добавил таймстапы для сообщений.
- Logger. Добавил цветовую индикацию для разных уровней сообщений

**2026-05-26**
- Отрефакторил метод DrawOutline в классе Renderer.
- Добавил outline для моделей.
...
**2026-05-22**
- Добавил кэш для загруженных на сцену моделей. Если пользователь добавляет на сцену модель, которая уже есть на сцене, то происходит создание модели на основе копии (без дерганья Assimp::Importer и IO)
- Поправил выбор одинаковых моделей на сцене (теперь у каждой модели на сцене свой id (в рамках сущностей моделей))
